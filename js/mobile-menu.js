document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".u-h-navigation-list");
  const headerRef = document.querySelector(".u-h-header");
  const navigationRef = document.querySelector(".u-h-navigation");
  ...
  document.querySelectorAll(".u-h-navigation-link").forEach((n) =>
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".u-h-toggle-button img");
